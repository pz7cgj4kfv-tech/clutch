...
const V = '0x1d0'  // Versionnage HEXADÉCIMAL. ~311e version. NB: le build Apple reste un entier dans pbxproj.
const BUILD = 204   // numéro de build Apple/TestFlight (= CURRENT_PROJECT_VERSION). À bumper avec V.
