...
const V = '0x1a5'  // Versionnage HEXADÉCIMAL. ~273e version. NB: le build Apple reste un entier dans pbxproj.
const BUILD = 161   // numéro de build Apple/TestFlight (= CURRENT_PROJECT_VERSION). À bumper avec V.
