...
const V = '0x1cf'  // Versionnage HEXADÉCIMAL. ~311e version. NB: le build Apple reste un entier dans pbxproj.
const BUILD = 203   // numéro de build Apple/TestFlight (= CURRENT_PROJECT_VERSION). À bumper avec V.
