...
const V = '0x168'  // Versionnage HEXADÉCIMAL. ~273e version. NB: le build Apple reste un entier dans pbxproj.
const BUILD = 102   // numéro de build Apple/TestFlight (= CURRENT_PROJECT_VERSION). À bumper avec V.
