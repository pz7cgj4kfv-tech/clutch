...
const TABS: { href: string; icon: string; t: string; d: string; group: string; accent?: string }[] = [
  ...
  { href: '/bible', icon: '📕', t: 'La Bible (handoff)', d: 'Tout le projet en un doc : concept, technique, base de données, business, roadmap — fond blanc, PDF', group: 'Docs', accent: M.green },
